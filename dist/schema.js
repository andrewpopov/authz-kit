...
exports.MEMBERSHIP_SCHEMA_SQL_POSTGRES = exports.MEMBERSHIP_SCHEMA_SQL = void 0;
/** SQLite-compatible DDL. `created_at` defaults to an ISO-8601 text timestamp via `datetime('now')`. */
exports.MEMBERSHIP_SCHEMA_SQL = `CREATE TABLE IF NOT EXISTS memberships (
...
exports.MEMBERSHIP_SCHEMA_SQL_POSTGRES = `CREATE TABLE IF NOT EXISTS memberships (
  scope_type TEXT NOT NULL,
  scope_id   TEXT NOT NULL,
  user_id    TEXT NOT NULL,
  role       TEXT NOT NULL,
